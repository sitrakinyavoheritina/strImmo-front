...
// backend valide le mot de passe avec `minLength 4` pour ces deux rôles (RegisterOwnerDto).
...
// `minLength 6`. Les documents CIN sont gérés hors zod (fichiers, voir register-agent-form.tsx) —
...
// Agence : email requis (contrairement à owner/tenant), mot de passe `minLength 6`, plus les

    ...
    <div className="bg-surface-card py-4 px-4 sm:py-8 sm:px-10 shadow-sm border border-stroke-default/80 rounded-xl sm:rounded-2xl">
      <form className="space-y-2.5 sm:space-y-4" onSubmit={onSubmit}>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              {...register('phone')}
              className={`w-full pl-14 pr-3 py-2 sm:py-2.5 bg-surface-app border rounded-xl text-sm text-content-main placeholder-content-muted focus:bg-surface-card focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition ${
                errors.phone ? 'border-red-500' : 'border-stroke-default'
              }`}
            />
          </div>
          {errors.phone && (
            <p className="mt-0.5 text-xs text-danger">{errors.phone.message}</p>
          )}
        </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full mt-1 sm:mt-2 py-2.5 sm:py-3 px-4 bg-brand-secondary hover:bg-brand-secondary-hover text-white font-semibold rounded-xl text-sm shadow-md shadow-orange-500/20 focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition disabled:opacity-50"
        >
